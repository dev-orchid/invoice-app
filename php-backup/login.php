...
<div id="main-wrapper">
 ...
 background-color: #cccccc;">
        ...
        <div class="col-lg-3">
          <div class="login-content card">
            <div class="login-form">
              <center>
                <h3 style="color:#5c4ac7">Sipahi Jee Metal Works</h3>
              </center>
              <!-- <center><img src="./assets/uploadImage/Logo/logo.jpg" style="width: 100%;"></center> -->
              <br>
  ...
  <center>
    <footer class="footer1"><b>Invoice System Designed by : <a href="javascript:void(0)" target="_blank">Orchid Software</a></b>
