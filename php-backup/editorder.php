...
$sql = "SELECT * FROM invoice_items WHERE id = {$invoiceId}";
//echo $sql;
...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-primary">Edit Order Management</h3>
		</div>
			...
			<div class="col-lg-11" style="    margin-left: 5%;">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="input-states">
							<form class="form-horizontal" method="POST" action="update-invoice.php" id="createOrderForm">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="gstin" placeholder="GST/IN/UN" autocomplete="off" required value="<?= $invoiceItems[0]['gstin'] ?>" />
										</div>
										<label class="col-sm-2 control-label">Invoice Date</label>
										<div class="col-sm-4">
											<input type="date" class="form-control" id="orderDate" name="orderDate" autocomplete="off" value="<?= $invoiceItems[0]['orderDate'] ?>" />
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										...
										<div class="col-sm-4">
											<textarea rows="10" cols="50" class="form-control shippingAddress" placeholder="Shipping Address.." id="clientName" name="clientName" required><?= htmlspecialchars($invoiceItems[0]['clientName']) ?></textarea>
										</div>

										<label class="col-sm-2 control-label">Client Contact No.</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Contact Number No." autocomplete="off" maxlength="10" onkeyup="javascript: this.value = this.value.replace(/[^0-9 + ]/g, '');" value="<?= $invoiceItems[0]['clientContact'] ?>" />
										</div>
								...
								<table class="table" id="productTable">
									...
									<tbody>
										...
										$arrayNumber = 0;
										$x = 1;
										foreach ($productName as $key => $values) {
											//echo '<pre>';
											//print_r($total);
											...
											<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
												<td style="margin-left:5px;">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="productName[]" id="productName<?php echo $values; ?>" placeholder="Description of Goods" value="<?= $values; ?>" />

													</div>
												</td>
												<td style="padding-left:5px;">
													<input type="text" name="hsn[]" id="hsn<?php echo $x; ?>" autocomplete="off" class="form-control" placeholder="HSN/SAC" value="<?= $hsn[$key] ?>" />
												</td>

												<td style="padding-left:5px;">
													<input type="text" name="rateValue[]" id="rateValue<?php echo $x; ?>" autocomplete="off" class="form-control" placeholder="Rate" value="<?= $rateValue[$key] ?>" />
												</td>
												<td style="padding-left:5px;">
													<div class="form-group">
														<input type="number" name="quantity[]" id="quantity<?php echo $x; ?>" autocomplete="off" class="form-control" min="1" placeholder="Quantity" onkeyup="getTotal(<?php echo $x ?>)" value="<?= $quantity[$key] ?>" />
													</div>
												</td>
												<td style="padding-left:5px;">
													<input type="text" name="perValue[]" id="perValue<?php echo $x; ?>" autocomplete="off" class="form-control" placeholder="per" value="<?= $per[$key] ?>" />
												</td>

												<td>
													<input type="text" name="total[]" id="total<?php echo $x; ?>" autocomplete="off" class="form-control" disabled="true" value="<?= $total[$key] ?>" />
													<input type="hidden" name="totalValue[]" id="totalValue<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?= $total[$key] ?>" />
												</td>
												<td>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" autocomplete="off" pattern="^[0-9]+$" value="<?= $invoiceItems[0]['discount'] ?>" />
						</div>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="paid" name="paid" value="<?= $invoiceItems[0]['paid_amount'] ?>" autocomplete="off" onkeyup="paidAmount()" />
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<select class="form-control" name="paymentType" id="paymentType">
								<option value="2" <?php echo (isset($invoiceItems[0]['payment_type']) && $invoiceItems[0]['payment_type'] == '2') ? 'selected' : ''; ?>>Cash</option>
								<option value="3" <?php echo (isset($invoiceItems[0]['payment_type']) && $invoiceItems[0]['payment_type'] == '3') ? 'selected' : ''; ?>>Phone Pe</option>
								<option value="4" <?php echo (isset($invoiceItems[0]['payment_type']) && $invoiceItems[0]['payment_type'] == '4') ? 'selected' : ''; ?>>Google Pay</option>
								<option value="5" <?php echo (isset($invoiceItems[0]['payment_type']) && $invoiceItems[0]['payment_type'] == '5') ? 'selected' : ''; ?>>Amazon Pay</option>
								<option value="1" <?php echo (isset($invoiceItems[0]['payment_type']) && $invoiceItems[0]['payment_type'] == '1') ? 'selected' : ''; ?>>Cheque</option>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<select class="form-control" name="paymentStatus" id="paymentStatus">
								...
								<option <?php echo (isset($invoiceItems[0]['pay_status']) && $invoiceItems[0]['pay_status'] == '1') ? 'selected' : ''; ?> value="1">Full Payment</option>
								<option <?php echo (isset($invoiceItems[0]['pay_status']) && $invoiceItems[0]['pay_status'] == '2') ? 'selected' : ''; ?> value="2">Advance Payment</option>
								<option <?php echo (isset($invoiceItems[0]['pay_status']) && $invoiceItems[0]['pay_status'] == '3') ? 'selected' : ''; ?>value="3">No Payment</option>
							</select>
						</div>
